...
public class CreatorResponseDTO {
    ...
    private final List<SocialAccountResponseDTO> socialAccounts;
    ...
    public CreatorResponseDTO(
            ...
            List<SocialAccountResponseDTO> socialAccounts
    ) {
        this.id = id;
        this.email = email;
    ...
    public List<SocialAccountResponseDTO> getSocialAccounts() {
    ...
    public boolean equals(Object o) {
        ...
        CreatorResponseDTO that = (CreatorResponseDTO) o;
